...
export default defineConfig({
  shortcuts: [
    ['btn', 'inline-block px-4 py-1 bg-#646cff bg-opacity-80 disabled:(opacity-20, bg-zinc-500) hover:bg-opacity-100 font-500 transition-all text-white'],
    ...
    ['m-input', 'border border-zinc-300 dark:border-zinc-600 !outline-none px-2 py-1 bg-transparent'],
