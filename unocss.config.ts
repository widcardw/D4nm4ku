...
export default defineConfig({
  shortcuts: [
    ['btn', 'inline-block px-4 py-1 border border-transparent rounded bg-#7f7f7f08 disabled:opacity-20 disabled:bg-zinc-200 dark:disabled:bg-zinc-800 hover:border-#646cff font-500 transition-all'],
